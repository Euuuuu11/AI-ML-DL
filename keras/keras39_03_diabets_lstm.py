...
scaler = MinMaxScaler()
x_train = scaler.fit_transform(x_train).reshape(353, 5, 2)
x_test = scaler.fit_transform(x_test).reshape(89, 5, 2)


#2. 모델 구성
model = Sequential()
model.add(LSTM(170, return_sequences=True, activation= 'relu' ,input_shape = (5,2)))    
...
# loss :  3357.133056640625
# r2스코어 0.37002220577633127