...
#model.save_weights("./_save/kersa23_9_save_weights_diabets.h5")
...
# model.save("./_save/kersa23_9_save_model_diabets.h5")

#model = load_model("./_save/kersa23_9_save_model_diabets.h5")

model.load_weights("./_save/kersa23_9_save_weights_diabets.h5")
