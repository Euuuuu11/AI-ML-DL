...
#2. 모델 구성
from tensorflow.python.keras.models import Sequential
from tensorflow.python.keras.layers import Conv2D,Flatten,Dense,MaxPool2D,MaxPooling1D
...
hist = model.fit(x_train,y_train,epochs=30,verbose=2,validation_split=0.25,batch_size=64)
...
# loss : 0.7144038081169128
# accuracy: 0.7363733053207397

# loss : 0.5409489274024963
# accuracy: 0.8108800053596497