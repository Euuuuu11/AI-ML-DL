...
model.fit(x_train, y_train, epochs=1001, batch_size=100)
...
submission = pd.read_csv('C:\study\_data\kaggle_house\sample_submission.csv',index_col=0)
submission['SalePrice'] = y_summit
submission.to_csv('C:\study\_data\kaggle_house\sample_submission.csv', index=True)
