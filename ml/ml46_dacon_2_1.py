...
import numpy as np 
#1. 데이터
path = 'D:\study_data\_data/dacon2/' # ".은 현재 폴더"
...
x = train_set_clean.drop(['TypeofContact','ProdTaken','NumberOfChildrenVisiting','NumberOfPersonVisiting','OwnCar', 'MonthlyIncome','NumberOfFollowups'], axis=1)
# x = train_set_clean.drop(['ProdTaken'], axis=1)
test_set = test_set.drop(['TypeofContact','NumberOfChildrenVisiting','NumberOfPersonVisiting','OwnCar', 'MonthlyIncome','NumberOfFollowups'], axis=1)
