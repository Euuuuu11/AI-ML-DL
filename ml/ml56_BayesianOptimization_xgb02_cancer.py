...
bayesian_params = {      
    'max_depth':(7,13),
    'min_child_weight' : (0.3,0.6),
    'subsample':(0.7,1.3),
    'colsample_bytree':(0.7,1.3),
    'reg_lambda' : (0.00001,0.0004),
    'reg_alpha':(74,80)
}
...
model = XGBClassifier(n_estimators = 500, learning_rate= 0.02, colsample_bytree =max(min(1.2884585190307694,1),0) ,
