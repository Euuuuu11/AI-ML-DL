...
x = np.delete(x, [2, 3, 4, 7, 9, 10], axis=1)
# print(x.shape)
...
# DecisionTreeClassifierr_score :  0.9166666666666666
# RandomForestClassifier_score :  1.0
# GradientBoostingClassifier_score :  0.9444444444444444
# XGBClassifier_score :  0.9444444444444444