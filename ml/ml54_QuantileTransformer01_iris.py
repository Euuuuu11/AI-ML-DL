...
####################################################################
# StandardScaler    그냥 결과 :  1.0
# MinMaxScaler      그냥 결과 :  0.9411
# MaxAbsScaler      그냥 결과 :  0.9411
# RobustScaler      그냥 결과 :    1.0
# QuantileTransformer     그냥 결과 :   1.0
# PowerTransformer(method = 'yeo-johnson')   그냥 결과 :  1.0
