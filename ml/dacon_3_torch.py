...
all_input_list = sorted(glob.glob('D:\study_data\_data\dacon3/train_input/*.csv'))
all_target_list = sorted(glob.glob('D:\study_data\_data\dacon3/train_target/*.csv'))
...
test_input_list = sorted(glob.glob('D:\study_data\_data\dacon3/test_input/*.csv'))
test_target_list = sorted(glob.glob('D:\study_data\_data\dacon3/test_target/*.csv'))
